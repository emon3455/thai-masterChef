...
const Footer = () => {
    return (
        <footer className="bg-base-200 ">
            <div className="footer container mx-auto p-2 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title">Services</span>
                    <p className="link link-hover">Branding</p>
                    <p className="link link-hover">Recepies</p>
                    <p className="link link-hover">Cheffs Info</p>
            ...
            <div className="footer container mx-auto p-2 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Thai Master Cheffs <br />Providing reliable cheffs since 2020</p>
                </div>
